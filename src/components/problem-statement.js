  ...
  return (
    <div key={problem_statement.id} className="ohack-problemstatement-feature">
      ...
      <div className="ohack-feature__description">
        ...
        >
          <ChildFriendlyIcon /> Born in&nbsp;
          <b>{problem_statement.first_thought_of}</b>
        </Grid>
        ...
        >
          <AccordionSummary
            ...
            id="panel3bh-header"
          >
            <Typography sx={{width: '33%', flexShrink: 0}}>Code</Typography>
      ...
      <Dialog open={volunteerOpen} onClose={handleVolunteerClose}>
        ...
        <DialogContent>
          ...
          >
            Please enter your information to register as a volunteer.
          </DialogContentText>
          <Box
            component="form"
            noValidate
        ...
        <DialogActions>
          <Button onClick={handleVolunteerClose}>Cancel</Button>
